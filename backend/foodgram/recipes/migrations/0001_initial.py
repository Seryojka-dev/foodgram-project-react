    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('#01796F', 'Темно-зеленый'), ('#0000FF', 'Синий'), ('#FFA500', 'Оранжевый'), ('#008000', 'Зеленый'), ('#800080', 'Фиолетовый'), ('#FFEA00', 'Желтый'), ('#FF0043', 'Красный')], max_length=7, unique=True, verbose_name='Цвет в HEX')),
